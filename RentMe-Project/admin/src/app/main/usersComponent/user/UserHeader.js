...
function UserHeader(props) {
	...
	const { formState, watch, getValues, reset, setValue } = methods;
				...
				<div className="flex items-center max-w-full">
					...
					>
						<img
							...
							src={getValues().profileImage || 'assets/images/ecommerce/product-image-placeholder.png'}
							alt={name}
						/>
					</motion.div>
