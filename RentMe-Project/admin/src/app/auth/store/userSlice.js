...
const userSlice = createSlice({
	...
	reducers: {
		setUser: (state, action) => {
			let role;
			if (action.payload.role.name.toLowerCase() === 'admin') {
				role = authRoles.admin;
			} else if (action.payload.role.name.toLowerCase() === 'landlord') {
			...
			return {
				...
				data: {
					...
					role: action.payload.role.name.toLowerCase(),
					photoURL: action.payload.profile?.profileImage || 'assets/images/avatars/Velazquez.jpg',
					shortcuts: []
				}
			};
		},
